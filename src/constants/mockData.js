...
const FN_ROSTER = [
  ...
  ['UQUxRAIC(', 'ES', 'c1_fastbot', 'د.م/ محمد إبراهيم بن ذالنون',
  ...
  ['عباقرة الفرسان', 'ES', 'c1_fastbot', 'عبدالله أمين محمد غراب',
  ...
  ['YouthDreams', 'MS', 'c1_fastbot', 'محمد العايد',
  ...
  ['رواد العطاء', 'HS', 'c1_linefollow', 'TBD', []],
  ...
  ['الشيوخ', 'MS', 'c2_soccer', 'أحمد عبادة علي عبد الله',
  ...
  ['UQUxRAIC', 'ES', 'c2_sumo', 'د.م/ محمد إبراهيم بن ذالنون',
    ['ملاذ محمد بن ذالنون', 'سارة محمد بن ذالنون']],
  ...
  ['مبدعي السلام بالخبر', 'ES', 'c3_ai', 'محمد عبد الحميد حسن أبوزايد',
  ...
  ['yWeb', 'US', 'c3_webdesign', 'د.م/ محمد إبراهيم بن ذالنون',
    ['عبد الله عادل خراز']],
  ['Web Innovators', 'HS', 'c3_webdesign', 'ملاك محمد الثمالي',
    ['عائشة سامي النمري', 'دانا فيصل القرشي', 'رسيل أحمد الأحمدي', 'ياسمين يوسف الحارثي']],
  ['Coder', 'HS', 'c3_webdesign', 'منال حسين الحارثي',
  ...
  ['يوث تيمز (YouthDreams)', 'MS', 'c3_webdesign', 'محمد العايد',
    ['محمد ثامر فهد الحارثي', 'ياسر منيف المطيري', 'كرم مهند العطار']],
];
